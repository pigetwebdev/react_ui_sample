...
import { Badge, Card, CardBody, CardFooter, CardHeader, Col, Row, Collapse, Fade,Pagination,PaginationItem,PaginationLink,Table } from 'reactstrap';
...
class DefaultAside extends Component {
  ...
  render() {
    ...
    const checkState = this.state.displayPage;
    return (
      <React.Fragment>
        <Nav tabs>
          <NavItem>
        ...
        <TabContent activeTab={this.state.activeTab}>
          ...
          <TabPane tabId="4" className="p-3">
            <AppSwitch className={'mx-1'} color={'warning'} checked onClick={this.onSwitchCheck}/>
